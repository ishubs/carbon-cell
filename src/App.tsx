...
function App() {
  ...
  return (
    <>
      <div>
        <p className='bg-blue text-4xl'>Carbon cell</p>
            ...
            <ul className="space-y-2 font-medium">
              ...
              <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  ...
                  <span className="flex-1 ms-3 whitespace-nowrap">Organisation</span>
                </a>
              </li>
              <li>
                <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <div className="p-4 sm:ml-64">
          ...
          <div className='bg-white w-fit mx-auto shadow-xl flex flex-col p-6'>
            <p className='mb-5 font-semibold text-xl'>Population Data</p>
